...
import { DayOfWeek, WeekType, ScheduleStatus } from '@eduplatform/types';
...
export class CreateScheduleDto {
  ...
  @ApiPropertyOptional({ enum: WeekType, default: WeekType.ALL, description: 'Hafta turi (all | numerator | denominator)' })
  @IsOptional()
  @IsEnum(WeekType)
  weekType?: WeekType;

  @ApiPropertyOptional({ enum: ScheduleStatus, default: ScheduleStatus.DRAFT, description: 'Boshlang\'ich status (faqat DIRECTOR/VP)' })
  @IsOptional()
