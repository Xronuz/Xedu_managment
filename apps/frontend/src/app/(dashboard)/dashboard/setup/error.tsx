...
export default function SetupErrorBoundary({
  error,
  reset,
}: {
    ...
    <div className="flex min-h-[60vh] flex-col items-center justify-center p-6">
      <div className="max-w-md w-full text-center space-y-5">
        ...
        <div className="space-y-2">
          <h2 className="text-lg font-semibold">Sozlash oynasi yuklanmadi</h2>
          <p className="text-sm text-xedu-slate-500">
            Maktabni sozlash sahifasini yuklashda xatolik yuz berdi. Qayta urinib ko&apos;ring.
          </p>
        </div>
