...
import {
  Calendar, BookOpen, FileText, GraduationCap, ChevronRight,
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start gap-4">
        <div className="h-12 w-12 rounded-2xl bg-xedu-sky/10 flex items-center justify-center shrink-0">
        ...
        {actions.map((a) => (
          ...
          >
            <div className="h-9 w-9 rounded-xl bg-xedu-slate-50 dark:bg-xedu-slate-800/60 flex items-center justify-center shrink-0">
              <a.icon className="h-[18px] w-[18px] text-xedu-sky" />
            </div>
