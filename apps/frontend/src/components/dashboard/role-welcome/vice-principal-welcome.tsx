...
/**
 * Vice Principal welcome/orientation card.
 */
export function VicePrincipalWelcome() {
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-xedu-slate-500 mt-0.5 max-w-lg">
            Siz o'rinbosar sifatida maktabingizning barcha operatsion jarayonlarini boshqarasiz.
