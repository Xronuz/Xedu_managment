  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        {branchPending > 0 && (
          <span className="flex items-center gap-1 text-[11px] font-bold text-amber-500 ml-auto">
...
function StaffTab({ teachers, staff, pendingLeaves }: { teachers: any[]; staff: any[]; pendingLeaves: number }) {
  return (
    <div className="space-y-4">
      ...
      {pendingLeaves > 0 && (
        <div className="flex items-center justify-between rounded-lg border border-amber-100 dark:border-amber-900/30 bg-amber-50 dark:bg-amber-900/10 px-3 py-2">
          <div className="flex items-center gap-2">
            <Clock className="h-3.5 w-3.5 text-amber-500" />
            <span className="text-xs font-medium text-amber-700 dark:text-amber-400">Ta'til so'rovlari</span>
          </div>
          <span className="text-xs font-bold text-amber-700 dark:text-amber-400">{pendingLeaves}</span>
        </div>
      )}
