...
const SEGMENT_LABELS: Record<string, string> = {
  ...
  'my-class': 'Mening sinfim',
  broadcast: 'Platforma e‘loni',
  ...
  clubs: 'To‘garaklar',
  resources: 'Resurslar',
  comms: 'Kommunikatsiya',
  alerts: 'Ogohlantirishlar',
  approvals: 'Tasdiqlash',
  ops: 'Operatsion markaz',
  display: 'Maktab ekrani',
  shop: 'Do‘kon',
  canteen: 'Oshxona',
...
export function BreadcrumbNav() {
  ...
  return (
    ...
    >
      <Link
        href="/dashboard"
        className="flex h-7 w-7 items-center justify-center rounded-lg bg-white shadow-pill text-slate-500 hover:text-slate-900 hover:shadow-sm transition-all dark:bg-slate-900 dark:text-slate-400 dark:hover:text-white"
      >
