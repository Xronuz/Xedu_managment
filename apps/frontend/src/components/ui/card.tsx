...
/**
 * Card — white elevated surface on the slate-100 canvas.
 * NO hard border. Shadow only separates card from background.
 * Tables inside keep their own compact padding.
 */
